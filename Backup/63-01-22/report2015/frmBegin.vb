...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.chk3T.Margin = New System.Windows.Forms.Padding(2)
        Me.chk3T.Name = "chk3T"
...
#End Region
    ...
    Sub getItemDetail()
        ...
        With subDS.Tables("Command")
            ...
            If (RowCount >= 1) Then
                ...
                For iRow = 0 To RowCount - 1     '  start code loop....for  บันทัดแรก
                    refCount = refCount + 1
                    rowNo = iRow + 1
                    ...
                    ElseIf dtlType = "X" Then
                        'dtlItem = "¢ÒÂÊÔ¹¤éÒãËé¡Ñº " & dbTools.findCusName(.Rows(iRow).Item("Trh_Cus"))
                        dtlItem = "เบิกใช้ภายใน " & CStr(.Rows(iRow).Item("Ar_Name"))
                    ...
                    ElseIf dtlType = "B" Then
                        ...
                        If IsDBNull(.Rows(iRow).Item("Ar_Name")) Then
                            dtlItem = " ******** ไม่พบชื่อลูกค้า ***********"
                        Else
                            dtlItem = CStr(.Rows(iRow).Item("Ar_Name"))
                        End If
                    ElseIf dtlType = "D" Then
                        If IsDBNull(.Rows(iRow).Item("Ar_Name")) Then
                            dtlItem = "รับสินค้าจากผลิต ******** ไม่พบชื่อลูกค้า ***********"
                        Else
                    ...
                    ElseIf dtlType = "G" Then
                        dtlItem = "MMA เข้าถังแผนกน้ำยา ."
                    ElseIf dtlType = "F" Then
                        dtlItem = "รับสินค้าจากการโอน " & CStr(.Rows(iRow).Item("Ar_Name"))
                    ...
                    ElseIf dtlType = "A" Then
                        ...
                        Else
                            dtlItem = "ปรับยอดตรวจนับ " & "-" & CStr(.Rows(iRow).Item("Ar_Name"))
                        End If

                    ElseIf dtlType = "Q" Then
                        If IsDBNull(.Rows(iRow).Item("Trh_date")) Then
                            dtlItem = "เอกสารตรวจนับ "
                        Else
                    ...
                    Else
                        If dtlType = "Q" Then
                            num = CDbl(.Rows(iRow).Item("Dtl_Num_2"))
                        Else
    ...
    Sub genSQLdetailByDoc() '  ===========   ÊÃéÒ§ÃÒÂ§Ò¹ àÍ¡ÊÒÃµèÒ§æ 
        ...
        txtSQL = "SELECT  "
        txtSQL = txtSQL & "TranDataH.Trh_Type,TranDataH.Trh_Prod_Sales,BaseMast.Stk_Prod,TranDataH.Trh_D_Amt,TranDAtaH.Trh_Cost_Amt,"
    ...
    Sub genSQLdetlByPenOr()   '  ===========   ÊÃéÒ§ÃÒÂ§Ò¹ Pending Order 
        ...
        txtSQL = "SELECT  "
        txtSQL = txtSQL & "TranDataH.Trh_Type,TranDataH.Trh_NoType,Trh_Disc,Trh_Amt,"
