...
Public NotInheritable Class DBConnString
    ...
    'Public Shared strConn2 As String = "Data Source=192.168.1.3\SQLEXPRESS;Initial Catalog=DB2012;User ID=sa;Password=$y$0500"
    Public Shared strConn2 As String = "Data Source=edp2\SQLEXPRESS;Initial Catalog=DB2012;User ID=sa;Password=sys0500"
    'Public Shared strConn2 As String = "Data Source=BD_Kritpon\SQLEXPRESS;Initial Catalog=DB2012;User ID=sa;Password=sys0500"

    'Public Shared strConn2 As String = "Data Source=EDP2\SQLEXPRESS;Initial Catalog=DB2006;User ID=sa;Password=sys0500"
    '===================================================================================
